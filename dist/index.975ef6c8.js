...
var input = document.querySelector("#text"), btn = document.querySelector("button"), ul = document.querySelector(".list ul"), li = document.querySelector(".list ul li");
btn.addEventListener("click", ()=>{
    const val = input.value;
    if (val == "" || val == " ") alert("Please Write Something First");
    else {
    ...
    /* to make the input empty after you click the button */ document.querySelector("#text").value = "";
});

},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire6dc6")
